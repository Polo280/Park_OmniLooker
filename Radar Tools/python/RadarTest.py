...
configFileName = 'C:/Users/jorgl/OneDrive/Escritorio/Park_Omnilooker/Radar Tools/python/Configs/PresenceDetect.cfg'
...
def parseConfigFile(configFileName):
    ...
    # Default values in case "profileCfg" isn't found
    numAdcSamplesRoundTo2 = None  # Initialize to None to check later if profileCfg was read
    ...
    # Ensure numAdcSamplesRoundTo2 was initialized by profileCfg
    if numAdcSamplesRoundTo2 is None:
        raise ValueError("profileCfg not found in configuration file.")
